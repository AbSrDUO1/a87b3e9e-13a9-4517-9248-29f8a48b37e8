  ...
  return (
    <div>
      <section id="hero" className="bg-gradient-to-r from-blue-200 to-indigo-500 py-20 flex flex-col items-center justify-center text-center">
        ...
        <TextRenderer config={{ text: 'Discover our innovative marketing solutions.', className: 'text-xl', useRetroText: false, animation: 'none', shadowColor: 'transparent', shadowOffset: '0', animationProps: null, gradientColors: { from: 'transparent', to: 'transparent' }}} as='p' />
